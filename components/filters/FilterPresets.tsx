...
export function FilterPresets() {
      ...
      },
  {
    ...
    filters: {
      ...
      yearRange: [2024, 2028],
      dataType: 'value',
      aggregationLevel: null, // Automatic level detection
    }
  },
]
  }, [data])
  ...
  const applyPreset = (preset: FilterPreset) => {
    ...
    const newFilters: Partial<FilterState> & { advancedSegments?: any[] } = { ...preset.filters }

    // CRITICAL: Clear advancedSegments when applying a preset
    // This ensures the preset's segments are used instead of stale advancedSegments
    newFilters.advancedSegments = []
